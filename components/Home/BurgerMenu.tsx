...
const BurgerMenu = ({ restaurants }: BurgerMenuProps) => {
  ...
  return (
    <section ref={menuRef}>
      ...
      <ul className={`${isOpen ? 'flex flex-col absolute w-11/12 animate right-2 top-14' : "hidden"} basis-2/3 bg-slate-100 rounded-lg flex-wrap gap-4 font-medium sm:invisible`}>
